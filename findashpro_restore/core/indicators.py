...
def calculate_rsi(close: pd.Series, period: int = 14) -> pd.Series:
    """
    RSI theo phương pháp Wilder (1978): làm mượt lũy thừa với alpha = 1/period.

    Wilder dùng trung bình lũy thừa chứ không phải trung bình động đơn giản: mỗi quan
    sát mới nhận trọng số alpha, toàn bộ lịch sử trước đó nhận trọng số (1 − alpha).
    Thay bằng rolling(period).mean() sẽ cho một chỉ báo khác, lệch rõ rệt trong khoảng
    30–50 quan sát đầu và hội tụ chậm dần về sau.
    """
    delta = close.diff()
